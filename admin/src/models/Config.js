...
import { findAll, findAllByPaging, add, update, remove, batchDelete, search } from '../services/ConfigService';
...
export default {
  ...
  reducers: {
    [SET_ALL](state, { payload: { configs, total } }) {
      return { ...state, configs, total };
    },
  },
  effects: {
